...
export const rentBike = (bike_id) => axios.patch(`${url}/rent/${bike_id}`, { withCredentials: true})
export const returnBike = (bike_id) => axios.patch(`${url}/return/${bike_id}`, { withCredentials: true})